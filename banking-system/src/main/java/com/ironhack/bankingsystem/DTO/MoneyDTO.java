...
public class MoneyDTO {
    ...
    public MoneyDTO(BigDecimal amount, Currency currency, RoundingMode rounding) {
    ...
    public BigDecimal increaseAmount(MoneyDTO money) {
    ...
    public BigDecimal decreaseAmount(MoneyDTO money) {
